...
app.post('/api/connector-operations/:id/reconcile',route(async(req,res)=>res.json(await swarm.workspace.reconcileOperation(req.params.id,AbortSignal.timeout(15000)))));
app.post('/api/connector-operations/:id/authorize-repeat',route((req,res)=>res.json(swarm.workspace.authorizeOperationRepeat(req.params.id))));
