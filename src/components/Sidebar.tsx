  ...
  return (
    <aside className="w-64 h-full bg-white border-r border-slate-200 flex flex-col shrink-0 select-none text-slate-800">
      ...
      <div className="p-4 border-t border-slate-100 shrink-0">
        <button onClick={onSignOut} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-medium text-slate-600 hover:text-slate-900 hover:bg-slate-50">
          <LogOut className="w-4 h-4 text-slate-500" /><span>Sign out</span>
        </button>
      </div>
    </aside>
  );
