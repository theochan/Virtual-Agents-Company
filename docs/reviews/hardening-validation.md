...
6. Review third-party rights before changing repository visibility. The owner subsequently selected Apache-2.0 for original project-owned code and documentation; see the root LICENSE and NOTICE. This does not resolve ownership or licensing questions for vendored assets, and committing and pushing source does not change repository visibility.
