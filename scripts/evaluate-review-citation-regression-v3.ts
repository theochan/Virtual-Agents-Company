...
function sourceHashes() {
  ...
  visit('src');
  files.push('server.ts', 'package.json', 'package-lock.json', 'scripts/evaluate-human-reviewed-packet.ts', 'scripts/evaluate-review-citation-regression-v3.ts');
