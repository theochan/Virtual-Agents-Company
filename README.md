...
The [22 September frozen pilot](docs/reviews/2026-09-22-priority-one.md) failed: one of eight reviewer cases falsely accepted an incorrect report, and both single-agent and two-specialist invoice tasks produced incorrect totals. A subsequent consistency-confirmation regression passed on the exposed failure and a correct control; it is not unseen qualification. Repeated workflow operations, execution-cost admission and two-stage review are implemented. Complete source-row accounting, deterministic reconciliation and demonstrated swarm advantage remain open under VAC-23, VAC-28 and VAC-42. The [parity assessment](docs/reviews/2026-09-22-swarm-parity-assessment.md) documents the wider gaps.
